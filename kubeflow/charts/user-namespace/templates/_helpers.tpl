...
*/}}
{{- define "user-namespace.imagePullSecrets" -}}
...
Usage: {{ include "user-namespace.suseImageRegistry" (dict "ctx" . "registry" .Values.pipelines.<component>.registry) }}
*/}}
{{- define "user-namespace.suseImageRegistry" -}}
{{- $ctx := .ctx -}}

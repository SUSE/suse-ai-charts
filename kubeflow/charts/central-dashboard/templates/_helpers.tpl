...
Common labels
*/}}
{{- define "central-dashboard.labels" -}}
...
Selector labels
*/}}
{{- define "central-dashboard.selectorLabels" -}}
...
*/}}
{{- define "central-dashboard.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "central-dashboard.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
Usage: include "central-dashboard.suseImageRegistry" (dict "ctx" $ "registry" .Values.image.registry)
*/}}
{{- define "central-dashboard.suseImageRegistry" -}}
{{- $ctx := .ctx -}}

...
*/}}
{{- define "admission-webhook.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "admission-webhook.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "admission-webhook.image" -}}
{{- $registry := .registry -}}
{{- if not $registry -}}
{{- $globalRegistry := "" -}}
...
*/}}
{{- define "admission-webhook.imagePullSecrets" -}}

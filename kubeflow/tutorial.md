...
> **Note:** The first run pulls `stgregistry.suse.com/ai/containers/tensorflow:2.15.0` (~1.3 GB).
...
```python
@dsl.component(base_image="stgregistry.suse.com/ai/containers/pytorch:2.11.0-cuda12.8-cudnn9-runtime")
def train_on_gpu(...):
    import torch
    ...
    Worker:
      ...
      template:
        spec:
          containers:
          - name: tensorflow
            image: stgregistry.suse.com/ai/containers/tensorflow:2.15.0
            resources:
              limits:
                nvidia.com/gpu: "1"
```
...
`stgregistry.suse.com/ai/containers/pytorch:*-cuda*` or
`stgregistry.suse.com/ai/containers/tensorflow:*` which include `nvidia-smi`.

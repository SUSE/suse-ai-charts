...
> **Note:** The first run pulls `registry.suse.com/ai/containers/tensorflow/tensorflow:2.15.0` (~1.3 GB).
...
spec:
  ...
  trainer:
    numNodes: 2
    image: registry.suse.com/ai/containers/pytorch/pytorch:2.11.0-cuda12.8-cudnn9-runtime
...
```python
@dsl.component(base_image="registry.suse.com/ai/containers/pytorch/pytorch:2.11.0-cuda12.8-cudnn9-runtime")
def train_on_gpu(...):
    import torch
    ...
    Worker:
      ...
      template:
        spec:
          containers:
          - name: tensorflow
            image: registry.suse.com/ai/containers/tensorflow/tensorflow:2.15.0
            resources:
              limits:
                nvidia.com/gpu: "1"
```
...
`registry.suse.com/ai/containers/pytorch/pytorch:*-cuda*` or
`registry.suse.com/ai/containers/tensorflow/tensorflow:*` which include `nvidia-smi`.
